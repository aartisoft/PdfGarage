...
public class AppSharedPreference {
    ...
    private static AppSharedPreference defaultPreferences =
...
//    private String driver_phone_number = "phone_number";
    ...
    public AppSharedPreference() {
        this.mPrefs = NearMeApp.getNearMeApp().
...
/**/
    ...
    public String getLast_latitude() {
        return mPrefs.getString(this.last_latitude, "23.8103");
    }
    ...
    public String getLast_longitude() {
        ...
        return mPrefs.getString(this.last_longitude, "90.4145");
